...
(function(global) {
  ...
  const TOAN_4_DATA = {
    ...
    topics: [
      { id: 'toan4_cd1', name: 'Chủ đề 1: Ôn tập và bổ sung', semester: 1, weeks: '1-3', volume: 1 },
      { id: 'toan4_cd2', name: 'Chủ đề 2: Góc và đơn vị đo góc', semester: 1, weeks: '3-5', volume: 1 },
      { id: 'toan4_cd3', name: 'Chủ đề 3: Số có nhiều chữ số', semester: 1, weeks: '5-8', volume: 1 },
      { id: 'toan4_cd4', name: 'Chủ đề 4: Một số đơn vị đo đại lượng', semester: 1, weeks: '8-11', volume: 1 },
      { id: 'toan4_cd5', name: 'Chủ đề 5: Phép cộng và phép trừ', semester: 1, weeks: '11-13', volume: 1 },
      { id: 'toan4_cd6', name: 'Chủ đề 6: Đường thẳng vuông góc, đường thẳng song song', semester: 1, weeks: '13-16', volume: 1 },
      { id: 'toan4_cd7', name: 'Chủ đề 7: Ôn tập học kỳ 1', semester: 1, weeks: '16-18', volume: 1 },
      { id: 'toan4_cd8', name: 'Chủ đề 8: Phép nhân, phép chia', semester: 2, weeks: '19-24', volume: 2 },
      { id: 'toan4_cd9', name: 'Chủ đề 9: Làm quen với yếu tố thống kê, xác suất', semester: 2, weeks: '24-25', volume: 2 },
      { id: 'toan4_cd10', name: 'Chủ đề 10: Phân số', semester: 2, weeks: '25-28', volume: 2 },
      { id: 'toan4_cd11', name: 'Chủ đề 11: Phép cộng, phép trừ phân số', semester: 2, weeks: '28-30', volume: 2 },
      { id: 'toan4_cd12', name: 'Chủ đề 12: Phép nhân, phép chia phân số', semester: 2, weeks: '30-33', volume: 2 },
      { id: 'toan4_cd13', name: 'Chủ đề 13: Ôn tập cuối năm', semester: 2, weeks: '33-35', volume: 2 }
    ],
    lessons: [
      {
        id: 'toan4_b1',
